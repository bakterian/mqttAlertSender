...
### BEGIN INIT INFO
# Provides:          MqttAlertSenderDeamon
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: DEBIAN initscript for node.js Mqtt Alert Sender App
# Description:       This node js driven service is used for checking if mqtt broadcasted measrument data is out of bounds and a e-mail notifcation is to be send.
...
DAEMON_ARGS="/home/pi/0_PublicHub/0_GIT/mqttAlertSender/mqttAlertSender.js -c /home/pi/0_PublicHub/0_GIT/CONFIG/mqttAlertSender/config.json"               # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="Mqtt Watchdog checks if mqtt data is in valid range"  # whatever fancy description you like
